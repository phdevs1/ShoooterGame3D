...
namespace tutoriales
{
    public class IkHandler : MonoBehaviour
    {
        ...
        private void OnAnimatorIK(int layerIndex)
        {
            ...
            //anim.SetLookAtWeight(1, BodyWeight, 1, 1, (Aiming ? 0 : 1));
        ...
        private void SetIk(AvatarIKGoal goal, Transform target, AvatarIKHint hint, Transform restrain, float weight, Vector3 recoil)
        {
            ...
            anim.SetIKHintPosition(hint, restrain.position);
        }
    }
